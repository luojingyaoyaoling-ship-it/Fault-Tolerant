...
public class BidPersonGeneratorKafka {
    ...
    public void run(String[] args) throws Exception {
        ...
        int resultOfPredict = loadPatternConfiguration.getLoadPattern().f1.get(0);

        int enableDynamicInterval = params.getInt("enable_dynamic_interval");
        int enableDynamicRatio = params.getInt("enable_dynamic_ratio");
        if ((enableDynamicRatio + enableDynamicInterval) != 0) {
            resultOfPredict = LoadPatternGenerator.predictLoadPatterRate(loadPatternConfiguration);
        }
        ...
        //Skew
        double skew = params.getDouble("skew", 0);
        ...
        for (int iteration = 0; iteration < loadPatternConfiguration.getLoadPatternPeriod(); iteration++) {
            int iterationInputRatePerSecond = resultOfPredict;
