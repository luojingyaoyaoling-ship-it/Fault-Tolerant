...
public class CosineLoadPattern extends SpikingLoadPattern {
    ...
    int cosinePeriod;
    int maxNoise;
    int enableDynamicInterval;
    int enableDynamicRatio;
    int degree;
     ...
     */
    public CosineLoadPattern(int query, int loadPatternPeriod, int cosinePeriod, int maximumDivergence, int meanInputRate, int maxNoise, int enableDynamicInterval, int enableDynamicRatio) {
        super(query, loadPatternPeriod);
        this.cosinePeriod = cosinePeriod;
        this.meanInputRate = meanInputRate;
        this.maximumDivergence = maximumDivergence;
        this.enableDynamicInterval = enableDynamicInterval;
        this.enableDynamicRatio = enableDynamicRatio;
        this.degree = enableDynamicRatio + enableDynamicInterval;
    ...
    public Tuple2<List<Integer>, List<Integer>> getLoadPattern() {
        ...
        for (int i = 0; i < this.getLoadPatternPeriod(); i++) {
            ...
            value += nextSpikeLoad + new Random().nextDouble() * 200 * this.degree;
